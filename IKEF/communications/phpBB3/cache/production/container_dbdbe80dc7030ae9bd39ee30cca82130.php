...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003169953b000000003f220a15(
...
class phpbbtemplatetwiglexer_000000003169953b000000003f220a15 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d524110df8dd198819518 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d524110df8e9604412112 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d524110df8aa410077284 = array(
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, 'set_environment', array('env' => $env), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;

        return $this->valueHolder5d524110df8dd198819518->set_environment($env);
    }
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;

        return $this->valueHolder5d524110df8dd198819518->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;

        return $this->valueHolder5d524110df8dd198819518->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d524110df8e9604412112 = $initializer;
    }
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, '__get', array('name' => $name), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;

        if (isset(self::$publicProperties5d524110df8aa410077284[$name])) {
            return $this->valueHolder5d524110df8dd198819518->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d524110df8dd198819518;
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, '__isset', array('name' => $name), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, '__unset', array('name' => $name), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;
    ...
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, '__clone', array(), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;

        $this->valueHolder5d524110df8dd198819518 = clone $this->valueHolder5d524110df8dd198819518;
    }

    public function __sleep()
    {
        $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, '__sleep', array(), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;

        return array('valueHolder5d524110df8dd198819518');
    }
    ...
    {
        return $this->initializer5d524110df8e9604412112;
    }
    ...
    {
        return $this->initializer5d524110df8e9604412112 && ($this->initializer5d524110df8e9604412112->__invoke($valueHolder5d524110df8dd198819518, $this, 'initializeProxy', array(), $this->initializer5d524110df8e9604412112) || 1) && $this->valueHolder5d524110df8dd198819518 = $valueHolder5d524110df8dd198819518;
    }
    ...
    {
        return null !== $this->valueHolder5d524110df8dd198819518;
    }
    ...
    {
        return $this->valueHolder5d524110df8dd198819518;
    }
