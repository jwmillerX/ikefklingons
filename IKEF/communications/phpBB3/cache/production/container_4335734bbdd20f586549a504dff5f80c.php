...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000003805d3820000000070056477(
...
class phpbbtemplatetwiglexer_000000003805d3820000000070056477 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d5241081802d194862829 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d52410818038385498657 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d52410818009726485366 = array(
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, 'set_environment', array('env' => $env), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;

        return $this->valueHolder5d5241081802d194862829->set_environment($env);
    }
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;

        return $this->valueHolder5d5241081802d194862829->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;

        return $this->valueHolder5d5241081802d194862829->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d52410818038385498657 = $initializer;
    }
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, '__get', array('name' => $name), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;

        if (isset(self::$publicProperties5d52410818009726485366[$name])) {
            return $this->valueHolder5d5241081802d194862829->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d5241081802d194862829;
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, '__isset', array('name' => $name), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, '__unset', array('name' => $name), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;
    ...
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, '__clone', array(), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;

        $this->valueHolder5d5241081802d194862829 = clone $this->valueHolder5d5241081802d194862829;
    }

    public function __sleep()
    {
        $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, '__sleep', array(), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;

        return array('valueHolder5d5241081802d194862829');
    }
    ...
    {
        return $this->initializer5d52410818038385498657;
    }
    ...
    {
        return $this->initializer5d52410818038385498657 && ($this->initializer5d52410818038385498657->__invoke($valueHolder5d5241081802d194862829, $this, 'initializeProxy', array(), $this->initializer5d52410818038385498657) || 1) && $this->valueHolder5d5241081802d194862829 = $valueHolder5d5241081802d194862829;
    }
    ...
    {
        return null !== $this->valueHolder5d5241081802d194862829;
    }
    ...
    {
        return $this->valueHolder5d5241081802d194862829;
    }
