...
/* forumlist_body.html */
class __TwigTemplate_b166e9b083c5f7b31a07be18c6418fe70443747bd0355bf10a121b152edcfe89 extends \Twig\Template
{
...
$context["forumrow"], "S_IS_LINK", [])) {
                    // line 79
                    echo "\t\t\t\t\t<dd class=\"topics\"><span class=\"badge count\">";
                    echo $this->getAttribute($context["forumrow"], "TOPICS", []);
                    echo "</span> <dfn>";
                    echo $this->env->getExtension('phpbb\template\twig\extension')->lang("TOPICS");
                    echo "</dfn></dd>
\t\t\t\t\t<dd class=\"posts\"><span class=\"badge count\">";
                    // line 80
...
\t\t\t\t\t\t\t";
                    ...
                    if ($this->getAttribute($context["forumrow"], "U_UNAPPROVED_TOPICS", [])) {
                        ...
                        echo "\">
\t\t\t\t\t\t\t\t\t<i class=\"icon fa-question fa-fw icon-orange\" aria-hidden=\"true\"></i><span class=\"sr-only\">";
                        // line 85
                        echo $this->env->getExtension('phpbb\template\twig\extension')->lang("TOPICS_UNAPPROVED");
                        echo "</span>
\t\t\t\t\t\t\t\t</a>
