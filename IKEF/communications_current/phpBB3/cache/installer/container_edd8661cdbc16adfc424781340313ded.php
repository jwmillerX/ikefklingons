...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001c6d2fb5000000005eecd574(
...
class phpbbtemplatetwiglexer_000000001c6d2fb5000000005eecd574 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d3e6a7e23bff979419489 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d3e6a7e23c0a412453740 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d3e6a7e23bdc625462911 = array(
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, 'set_environment', array('env' => $env), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;

        return $this->valueHolder5d3e6a7e23bff979419489->set_environment($env);
    }
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;

        return $this->valueHolder5d3e6a7e23bff979419489->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;

        return $this->valueHolder5d3e6a7e23bff979419489->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 = $initializer;
    }
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, '__get', array('name' => $name), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;

        if (isset(self::$publicProperties5d3e6a7e23bdc625462911[$name])) {
            return $this->valueHolder5d3e6a7e23bff979419489->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d3e6a7e23bff979419489;
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, '__isset', array('name' => $name), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, '__unset', array('name' => $name), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;
    ...
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, '__clone', array(), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;

        $this->valueHolder5d3e6a7e23bff979419489 = clone $this->valueHolder5d3e6a7e23bff979419489;
    }

    public function __sleep()
    {
        $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, '__sleep', array(), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;

        return array('valueHolder5d3e6a7e23bff979419489');
    }
    ...
    {
        return $this->initializer5d3e6a7e23c0a412453740;
    }
    ...
    {
        return $this->initializer5d3e6a7e23c0a412453740 && ($this->initializer5d3e6a7e23c0a412453740->__invoke($valueHolder5d3e6a7e23bff979419489, $this, 'initializeProxy', array(), $this->initializer5d3e6a7e23c0a412453740) || 1) && $this->valueHolder5d3e6a7e23bff979419489 = $valueHolder5d3e6a7e23bff979419489;
    }
    ...
    {
        return null !== $this->valueHolder5d3e6a7e23bff979419489;
    }
    ...
    {
        return $this->valueHolder5d3e6a7e23bff979419489;
    }
