...
var tryLoadImage = function( index ){
   tempImg.src = 'http://www.ikefklingons.com/images/ships/drydock/drydock_' + index + '.jpg';
}
var appendImage = function(){
   ...
   img.width = 300;
   img.hspace = 3;
   img.style.border = "thick ridge #AA0000";
   var fullPath = img.src;
   var filenameIndex = fullPath.lastIndexOf("/");
   if(filenameIndex !== -1) {     
       filename = fullPath.substring(filenameIndex+1,fullPath.length-4);
   }
   img.alt = filename;
   img.title = filename;
...
function openit(a, b) {
   ...
   sc2001images[a] = "";
   sc2001images[a] = new Image(400, 200);
   ...
   desc = "<table cellpadding=3 bgcolor=000000 align=center style=\"border-width:2px; border-style:solid; border-color:Red\" ><tr><td>";
   if ((c == "jpg") || (c == "gif") || (c == "png")) {
      ...
      desc += '<a href="'
            ...
            + b
            + '" WIDTH="'
            + sc2001images[a].width
            / 1.25
            + '"></a><br><CENTER><a href="javascript:closeit(-400);"><font face=KlingonDagger>Close this Window</font></a></CENTER>';

   } else if (c == "pdf") {
      // alert(b);
      desc += '<iframe src="' + b + '" width="400" ></iframe>';
      desc += '<CENTER><a href="' + b
            + '" width="400" target=_newpdf>Download pdf</a><br>';
      ...
      desc += '<CENTER><a href="'
            + b
            + '" width="400" ><img src=http://www.housevampyr.com/training/library/zip.png width=75></a><br>';
      desc += '<a href="javascript:closeit(-400);"><font face=KlingonDagger>Close this Window</font></a></CENTER>';

   } else {
      desc += '<iframe src="'
            + b
            + '" width="400" height="325" style="border-width:2px; border-style:solid; border-color:Red"></iframe>';
   ...
   if (isNav) {
      ...
      popbox.style.left = (x - 200 - xx) + "px";
      popbox.style.top = (y - 10 + (yy / 80)) + "px";
   } else {
